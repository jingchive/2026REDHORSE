import svgPaths from "./svg-on6a90b19c";
...
export default function Component1() {
  return (
    <div className="bg-[#faf7f5] relative size-full" data-name="말 만들기 1">
      ...
      <div className="absolute aspect-[1031.7/595.261] left-[34.1%] right-[30.79%] top-[calc(50%+52px)] translate-y-[-50%]" data-name="running horse2">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 138 80">
          <g id="running horse2">
            <mask fill="white" id="path-1-inside-1_3_829">
              <path d={svgPaths.p288b6300} />
            </mask>
            <path d={svgPaths.p288b6300} mask="url(#path-1-inside-1_3_829)" stroke="var(--stroke-0, #A04842)" strokeWidth="2" />
          </g>
        </svg>
      </div>
